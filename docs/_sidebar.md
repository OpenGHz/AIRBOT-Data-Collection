<!-- 侧边栏导航：所有链接均使用以 / 开头的绝对路径（从 docs/ 根解析），
     避免在嵌套页面下点击相对链接时产生重复路径 404。 -->

- 入门与使用
  - [文档首页](/)
  - [项目简介](/intro.md)
  - [快速开始](/quik_start.md)
  - [Pixi 环境与工作流](/setup/pixi.md)
  - [AIRBOT Play 安装指南](/setup/airbot_play.md)
  - [AIRBOT Play 配置说明](/configure/airbot_play.md)
  - [常见配置调整](/configure/common.md)
  - [配置框架说明](/configure/cfger.md)
  - [AIRBOT Play 遥操说明](/teleop/airbot_play.md)
...
- 运维与数据检查
  ...
  - [数据可视化：AIRBOT Viewer](/visualize/airbot.md)
...
- 产品与规划
  ...
  - [Persona：采集操作员](/product/personas/robot-operator.md)
  - [Persona：数据工程师](/product/personas/data-engineer.md)
  - [Persona：平台维护者](/product/personas/platform-maintainer.md)
